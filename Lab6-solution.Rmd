...
head(dennys)
```
The `dennys` dataset has 1,643 rows and 6 columns. Each row represents an address of a denny's restaurant.
...
head(laquinta)
```
This dataset has 909 rows and 6 columns. Each row represents an address of laquinta's hotel.
