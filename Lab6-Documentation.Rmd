...
answer: row = 1643 , column = 6
the row its about the resturant address (more information about it)
...
2.  What are the dimensions of the La Quinta's dataset?
    ...
    What are the variables?
answer: row = 909 , column = 6
the row its about the hotels address (more information about it)
column (address , city , state , zip , longitude , latitude)
...
answer:Denny's the most = CA and the Fewset = DE
